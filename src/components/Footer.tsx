...
export default function Footer() {
  return (
    <Box bg="black" color={"white"} mt={32}>
      <Container as={Stack} maxW={"6xl"} py={10}>
        <SimpleGrid
          templateColumns={{ sm: "1fr 1fr", md: "2fr 6fr 2fr" }}
          spacing={8}
        >
          <Stack spacing={6}>
            <Box>
          ...
          <Flex mt={2} justify={"space-between"}>
            <Stack align={"flex-center"}>
              ...
              <Box fontWeight={300} fontSize={"14px"} as="a" href={"#"}>
                For students
              </Box>
              <Box fontWeight={300} fontSize={"14px"} as="a" href={"#"}>
                For donations
        ...
        <Center mt={8} mb={4}>
          <Text fontSize={"sm"}>
            <span className="bg-teal">©</span> Copyright 2024. Assist A Student
          </Text>
        </Center>
      </Container>
    </Box>
